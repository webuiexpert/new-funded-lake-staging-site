...
function PrimaryButton({ text, link }) {
  return (
    <NavLink to={link} target="_blank" rel="noopener noreferrer">
      <span className="relative inline-flex items-center justify-center px-10 py-4 rounded-md border border-[#011667] bg-[linear-gradient(180deg,#0d001f_0%,#12022d_100%)] text-[#fff] font-semibold transition-all duration-500 hover:shadow-[0_0_25px_#011667,inset_0_0_15px_#011667] hover:border-[#011667] hover:text-[#fff] group overflow-hidden">
      {/* Left Arrows */}
      <span className="relative flex items-center justify-center mr-6">
        <small className="absolute top-[-10px] left-[-30px] w-2 h-2 bg-transparent border border-[#011667] rounded-full opacity-70 group-hover:opacity-100 transition-all duration-300"></small>
        <small className="absolute bottom-[-10px] left-[-30px] w-2 h-2 border border-[#011667] rounded-full opacity-70 group-hover:opacity-100 transition-all duration-300"></small>
        <svg
      ...
      <span className="relative flex items-center justify-center ml-4">
        <small className="absolute top-[-10px] right-[-30px] w-2 h-2 border border-[#011667] rounded-full opacity-70 group-hover:opacity-100 transition-all duration-300"></small>
        <small className="absolute bottom-[-10px] right-[-30px] w-2 h-2 border border-[#011667] rounded-full opacity-70 group-hover:opacity-100 transition-all duration-300"></small>
        <svg
          className="w-5 h-5 fill-[#011667] group-hover:fill-[#fff] group-hover:scale-[1.1] transition-all duration-300"
          viewBox="0 0 27 23"
          xmlns="http://www.w3.org/2000/svg"
