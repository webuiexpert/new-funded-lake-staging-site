...
const MapSection = () => {
  return (
    <div className="relative text-white lg:h-[120vh] xl:h-auto h-auto py-24 xl:py-44 px-6 md:px-16 grid md:grid-cols-2 gap-12 items-center font-lexend">
      ...
      >
        <h5 className="text-2xl md:text-[3.5rem] text-white font-bold mb-6 md:text-left w-full text-center">
