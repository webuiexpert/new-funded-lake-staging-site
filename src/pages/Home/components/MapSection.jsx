...
const MapSection = () => {
  return (
    <div className="relative text-white lg:h-[120vh] xl:h-auto h-auto py-20 xl:py-44 px-6 md:px-16 grid md:grid-cols-2 gap-12 items-center font-lexend">
      ...
      <motion.div
        ...
        className="max-w-xl"
      >
        <h5 className="text-4xl md:text-[3.5rem] text-white font-bold mb-6">
