...
const ContactUs = () => {
  ...
  return (
    <>
      ...
      <div className="lg:py-32 md:py-16 py-10 md:px-0 px-4 relative overflow-hidden">
      ...
      {/* <div className="ripple-shape2 z-30">
        ...
        <img className="upDownAnim absolute lg:w-24 w-20 md:bottom-6 bottom-10 md:left-10 left-5 opacity-60"
              src={walletIcon}
              alt=""
            />
        <div className="flex flex-wrap w-full flex-col items-center text-center">
          ...
          <p className="text-white md:text-xl text-base mt-6 md:max-w-[800px] w-full">
            We’re here to help you. Feel free to reach out with any questions or
            feedback — our team will get back to you as soon as possible.
          </p>
        </div>
      </div>
      <ContactForm />
